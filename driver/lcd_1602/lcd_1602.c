...
static void lcd_1602_i2c_write_4bit(uint8_t write_data)
{
    ...
    HAL_I2C_Master_Transmit(ptr_lcd_1602_i2c_connect_mode, DEVICE_I2C_ADDRESS, (uint8_t*)&data, 1, 3);
}
...
void lcd_1602_control_lcd_and_backlight(uint8_t control_state)
{
	lcd_1602_write_instruction(CLEAR_DISPLAY);
	delay_ms(2);
